# AGENTS.md — HostAdvance project guide

You (Codex) are building out **hostadvance.com**: an independent affiliate
...
- One AI workspace to chat with multiple leading models: ChatGPT, Codex,
